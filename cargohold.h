...
public  :
    ...
    CargoHold(Ship* PTR,unsigned int sm, unsigned int , unsigned int sm, unsigned int sm,
    ~CargoHold();
...
CargoHold::CargoHold(Ship* PTR,unsigned int sm, unsigned int CARGOHOLDTYPE)  : System(PTR), SM(sm), cargoHoldType(CARGOHOLDTYPE)
{
